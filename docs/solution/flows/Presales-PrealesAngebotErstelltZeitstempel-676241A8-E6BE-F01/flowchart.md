...
flowchart TD
    ...
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__8176["Änderungen_für_ein_Element_oder_eine_Datei_abrufen_(nur_Eigenschaften)\n[SharePoint]"]
    TRIGGER --> nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__8176
    Bedingung_7952{{"Bedingung"}}
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__8176 --> Bedingung_7952
    Bedingung_Ja_8400(["Bedingung – Ja"])
    Bedingung_7952 -->|Ja| Bedingung_Ja_8400
    Element_aktualisieren_9072["Element_aktualisieren\n[SharePoint]"]
    Bedingung_Ja_8400 --> Element_aktualisieren_9072
    Element_aktualisieren_8624["Element_aktualisieren\n[SharePoint]"]
    Bedingung_7952 --> Element_aktualisieren_8624
    FLOW_END(["Ende"])
    Element_aktualisieren_9072 --> FLOW_END
    Element_aktualisieren_8624 --> FLOW_END

    class TRIGGER trigger
    class nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__8176 connector
    class Bedingung_7952 condition
    class Bedingung_Ja_8400 branch_true
    class Element_aktualisieren_9072 connector
    class Element_aktualisieren_8624 connector
