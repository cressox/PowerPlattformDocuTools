...
flowchart TD
    ...
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__608["Änderungen_für_ein_Element_oder_eine_Datei_abrufen_(nur_Eigenschaften)\n[SharePoint]"]
    TRIGGER --> nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__608
    Bedingung_832{{"Bedingung"}}
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__608 --> Bedingung_832
    Bedingung_Ja_1280(["Bedingung – Ja"])
    Bedingung_832 -->|Ja| Bedingung_Ja_1280
    E_Mail_senden_V2_1728["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_Ja_1280 --> E_Mail_senden_V2_1728
    E_Mail_senden_V2_1952["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_832 --> E_Mail_senden_V2_1952
    FLOW_END(["Ende"])
    E_Mail_senden_V2_1728 --> FLOW_END
    E_Mail_senden_V2_1952 --> FLOW_END

    class TRIGGER trigger
    class nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__608 connector
    class Bedingung_832 condition
    class Bedingung_Ja_1280 branch_true
    class E_Mail_senden_V2_1728 connector
    class E_Mail_senden_V2_1952 connector
