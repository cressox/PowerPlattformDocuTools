...
```mermaid
flowchart TD
    TRIGGER(["⚡ When_an_item_is_created\n[SharePoint]\n(Recurrence)"])
    Scope_9376(["Scope"])
    TRIGGER --> Scope_9376
    Update_item_9824["Update_item\n[SharePoint]"]
    Scope_9376 --> Update_item_9824
    Send_an_email_V2_9152["Send_an_email_(V2)\n[Office 365 Outlook]"]
    Update_item_9824 --> Send_an_email_V2_9152
    Send_an_email_V2_2_9600["Send_an_email_(V2)_2\n[Office 365 Outlook]"]
    Send_an_email_V2_9152 --> Send_an_email_V2_2_9600
    FLOW_END(["Ende"])
    Send_an_email_V2_2_9600 --> FLOW_END

    class TRIGGER trigger
    class Scope_9376 scope
    class Update_item_9824 connector
    class Send_an_email_V2_9152 connector
    class Send_an_email_V2_2_9600 connector
