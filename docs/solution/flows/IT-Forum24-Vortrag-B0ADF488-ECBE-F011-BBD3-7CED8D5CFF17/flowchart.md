...
flowchart TD
    ...
    Antwortdetails_abrufen_1536["Antwortdetails_abrufen\n[shared_microsoftforms]"]
    TRIGGER --> Antwortdetails_abrufen_1536
    Element_erstellen_864["Element_erstellen\n[SharePoint]"]
    Antwortdetails_abrufen_1536 --> Element_erstellen_864
    Verfassen_1312["Verfassen"]
    Element_erstellen_864 --> Verfassen_1312
    E_Mail_senden_V2_1760["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Verfassen_1312 --> E_Mail_senden_V2_1760
    FLOW_END(["Ende"])
    E_Mail_senden_V2_1760 --> FLOW_END

    class TRIGGER trigger
    class Antwortdetails_abrufen_1536 connector
    class Element_erstellen_864 connector
    class Verfassen_1312 data
    class E_Mail_senden_V2_1760 connector
