...
flowchart TD
    ...
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__384["Änderungen_für_ein_Element_oder_eine_Datei_abrufen_(nur_Eigenschaften)\n[SharePoint]"]
    TRIGGER --> nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__384
    Bedingung_9936{{"Bedingung"}}
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__384 --> Bedingung_9936
    Bedingung_Ja_1504(["Bedingung – Ja"])
    Bedingung_9936 -->|Ja| Bedingung_Ja_1504
    E_Mail_senden_V2_1056["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_Ja_1504 --> E_Mail_senden_V2_1056
    E_Mail_senden_V2_160["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_9936 --> E_Mail_senden_V2_160
    FLOW_END(["Ende"])
    E_Mail_senden_V2_1056 --> FLOW_END
    E_Mail_senden_V2_160 --> FLOW_END

    class TRIGGER trigger
    class nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__384 connector
    class Bedingung_9936 condition
    class Bedingung_Ja_1504 branch_true
    class E_Mail_senden_V2_1056 connector
    class E_Mail_senden_V2_160 connector
