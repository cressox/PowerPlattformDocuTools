...
flowchart TD
    ...
    Get_changes_for_an_item_or_a_file_properties_only_8576["Get_changes_for_an_item_or_a_file_(properties_only)\n[SharePoint]"]
    TRIGGER --> Get_changes_for_an_item_or_a_file_properties_only_8576
    Condition_8352{{"Condition"}}
    Get_changes_for_an_item_or_a_file_properties_only_8576 --> Condition_8352
    Condition_Ja_8800(["Condition – Ja"])
    Condition_8352 -->|Ja| Condition_Ja_8800
    Send_an_email_V2_9248["Send_an_email_(V2)\n[Office 365 Outlook]"]
    Condition_Ja_8800 --> Send_an_email_V2_9248
    Send_an_email_V2_9024["Send_an_email_(V2)\n[Office 365 Outlook]"]
    Condition_8352 --> Send_an_email_V2_9024
    FLOW_END(["Ende"])
    Send_an_email_V2_9248 --> FLOW_END
    Send_an_email_V2_9024 --> FLOW_END

    class TRIGGER trigger
    class Get_changes_for_an_item_or_a_file_properties_only_8576 connector
    class Condition_8352 condition
    class Condition_Ja_8800 branch_true
    class Send_an_email_V2_9248 connector
    class Send_an_email_V2_9024 connector
