...
flowchart TD
    ...
    Scope_6560(["Scope"])
    TRIGGER --> Scope_6560
    Update_item_7008["Update_item\n[SharePoint]"]
    Scope_6560 --> Update_item_7008
    Send_an_email_V2_6336["Send_an_email_(V2)\n[Office 365 Outlook]"]
    Update_item_7008 --> Send_an_email_V2_6336
    Send_an_email_V2_2_6784["Send_an_email_(V2)_2\n[Office 365 Outlook]"]
    Send_an_email_V2_6336 --> Send_an_email_V2_2_6784
    FLOW_END(["Ende"])
    Send_an_email_V2_2_6784 --> FLOW_END

    class TRIGGER trigger
    class Scope_6560 scope
    class Update_item_7008 connector
    class Send_an_email_V2_6336 connector
    class Send_an_email_V2_2_6784 connector
