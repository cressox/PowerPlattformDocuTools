...
flowchart TD
    ...
    Antwortdetails_abrufen_8720["Antwortdetails_abrufen\n[shared_microsoftforms]"]
    TRIGGER --> Antwortdetails_abrufen_8720
    Element_erstellen_8048["Element_erstellen\n[SharePoint]"]
    Antwortdetails_abrufen_8720 --> Element_erstellen_8048
    Verfassen_8496["Verfassen"]
    Element_erstellen_8048 --> Verfassen_8496
    E_Mail_senden_V2_8944["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Verfassen_8496 --> E_Mail_senden_V2_8944
    FLOW_END(["Ende"])
    E_Mail_senden_V2_8944 --> FLOW_END

    class TRIGGER trigger
    class Antwortdetails_abrufen_8720 connector
    class Element_erstellen_8048 connector
    class Verfassen_8496 data
    class E_Mail_senden_V2_8944 connector
