...
flowchart TD
    ...
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__5360["Änderungen_für_ein_Element_oder_eine_Datei_abrufen_(nur_Eigenschaften)\n[SharePoint]"]
    TRIGGER --> nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__5360
    Bedingung_5136{{"Bedingung"}}
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__5360 --> Bedingung_5136
    Bedingung_Ja_5584(["Bedingung – Ja"])
    Bedingung_5136 -->|Ja| Bedingung_Ja_5584
    Element_aktualisieren_6256["Element_aktualisieren\n[SharePoint]"]
    Bedingung_Ja_5584 --> Element_aktualisieren_6256
    Element_aktualisieren_5808["Element_aktualisieren\n[SharePoint]"]
    Bedingung_5136 --> Element_aktualisieren_5808
    FLOW_END(["Ende"])
    Element_aktualisieren_6256 --> FLOW_END
    Element_aktualisieren_5808 --> FLOW_END

    class TRIGGER trigger
    class nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__5360 connector
    class Bedingung_5136 condition
    class Bedingung_Ja_5584 branch_true
    class Element_aktualisieren_6256 connector
    class Element_aktualisieren_5808 connector
