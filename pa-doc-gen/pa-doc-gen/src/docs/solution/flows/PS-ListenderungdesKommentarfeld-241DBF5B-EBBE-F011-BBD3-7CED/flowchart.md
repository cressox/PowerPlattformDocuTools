...
flowchart TD
    ...
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__7376["Änderungen_für_ein_Element_oder_eine_Datei_abrufen_(nur_Eigenschaften)\n[SharePoint]"]
    TRIGGER --> nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__7376
    Bedingung_7152{{"Bedingung"}}
    nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__7376 --> Bedingung_7152
    Bedingung_Ja_7600(["Bedingung – Ja"])
    Bedingung_7152 -->|Ja| Bedingung_Ja_7600
    E_Mail_senden_V2_8272["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_Ja_7600 --> E_Mail_senden_V2_8272
    E_Mail_senden_V2_7824["E-Mail_senden_(V2)\n[Office 365 Outlook]"]
    Bedingung_7152 --> E_Mail_senden_V2_7824
    FLOW_END(["Ende"])
    E_Mail_senden_V2_8272 --> FLOW_END
    E_Mail_senden_V2_7824 --> FLOW_END

    class TRIGGER trigger
    class nderungen_f_r_ein_Element_oder_eine_Datei_abrufen__7376 connector
    class Bedingung_7152 condition
    class Bedingung_Ja_7600 branch_true
    class E_Mail_senden_V2_8272 connector
    class E_Mail_senden_V2_7824 connector
